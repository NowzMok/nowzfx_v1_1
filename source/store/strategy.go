...
type StrategyConfig struct {
	...
	// trigger price strategy configuration
...
// TriggerPriceStrategy 触发价格策略配置 (简化版本，匹配前端格式)
type TriggerPriceStrategy struct {
	// 触发模式: "current_price" | "pullback" | "breakout"
	Mode string `json:"mode"`

	// 交易风格: "long_term" | "short_term" | "swing" | "scalp"
...
func GetDefaultStrategyConfig(lang string) StrategyConfig {
	...
	config := StrategyConfig{
		...
		TriggerPriceConfig: GetDefaultTriggerPriceConfig("swing"),
	}
