...
import { PositionProvider, usePositions } from './contexts/PositionContext'
...
import TPSLManagementPage from './pages/TPSLManagementPage'
...
function AppContent() {
  ...
  const { setPositions } = usePositions() // 获取 setPositions 函数
  ...
  const getInitialPage = (): Page => {
    ...
    if (path === '/tpsl-manager' || hash === 'tpsl-manager') return 'tpsl-manager'
    if (path === '/strategy-comparison' || hash === 'strategy-comparison') return 'strategy-comparison'
  ...
  useEffect(() => {
    const handleRouteChange = () => {
      ...
      } else if (path === '/tpsl-manager' || hash === 'tpsl-manager') {
        setCurrentPage('tpsl-manager')
      } else if (path === '/strategy-comparison' || hash === 'strategy-comparison') {
        setCurrentPage('strategy-comparison')
      } else if (
        path === '/dashboard' ||
        hash === 'trader' ||
        hash === 'details'
        ...
        <AnimatePresence mode="wait">
          ...
          >
            {currentPage === 'competition' ? (
              ...
              <DebateArenaPage />
            ) : currentPage === 'tpsl-manager' ? (
              <TPSLManagementPage traderId={selectedTraderId} />
            ) : currentPage === 'strategy-comparison' ? (
