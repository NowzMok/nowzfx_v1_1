...
export interface TPSLRecord {
  ...
  tp_triggered_at?: string
  sl_triggered_at?: string
...
export interface StrategyConfig {
  ...
  trigger_price_config?: TriggerPriceStrategy
}
...
export interface IndicatorConfig {
  ...
  // Trigger Price Strategy - 根据交易员风格自动调整触发价格
  trigger_price_config?: TriggerPriceStrategy
}
...
// Adaptive Stop Loss Types
export interface AdaptiveStopLossRecord {
  id: string
  trader_id: string
  symbol: string
  position_id?: string
...
export interface AdaptiveStopLossResponse {
  exists: boolean
  records?: AdaptiveStopLossRecord[]
  message?: string
}

export interface AdaptiveStopLossUpdateRequest {
  enabled: boolean
  initial_stop_loss?: number
  entry_price?: number
  symbol?: string
